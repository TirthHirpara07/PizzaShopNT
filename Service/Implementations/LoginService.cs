...
public class LoginService : ILoginService
{
   ...
   public async Task<RedirectResult> SignIn(UserLoginBean user)
   {
      ...
      // _httpcontext.HttpContext.Session.SetString("Role", role);
      // _httpcontext.HttpContext.Session.SetInt32("Userid", (Int32)Userid);
      // _httpcontext.HttpContext.Session.SetString("Username", username);
      _httpcontext.HttpContext.Session.SetString("UserImg", (userimg == null) ? "https://i.ibb.co/JW8s0S7m/Default-pfp-svg.png" : userimg);
